...
#[test]
fn test_issue_vc_to_holder_and_blockchain() {
    ...
    // Placeholder Ethereum address for the holder (replace with real address if needed)
    let to_address = "0x000000000000000000000000000000000000dead";
    ...
    println!("Credential issued to holder: {:?}", credential.messages);
